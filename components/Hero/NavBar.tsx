    ...
    return (
        <div className={`flex justify-center  ${onscroll ? "backdrop-blur-md bg-black/45" : "bg-transparent"}  font-Poppins navb  fixed w-full h-20 items-center`}>
            <div className='w-9/12 text-white flex justify-between  '>
                ...
                <div className={`${showNav? "opacity-100 z-10 top-20 ":"opacity-0 z-0 -top-20"} duration-700 flex gap-7 max-md:absolute justify-center md:items-center rounded-lg border   w-9/12 max-md:bg-black py-1 md:h-20`}>
