        ...
        <div id='variant' className='overflow-hidden relative font-Poppins  z-menu '>
            <div ref={triggerRef}>
                ...
                <div ref={bodyMenu} className='h-screen flex flex-row w-v relative'>
                    <div className='w-screen flex items-center relative z-40 h-screen justify-center bg-black/75 backdrop-blur-md'>
                            ...
                            <div key={index} className={`w-screen gap-2 max-md:px-5 max-md:pt-10 text-${e.text} shadow-xl shadow-${e.bg} flex max-md:flex-col items-center h-screen justify-center bg-${e.bg} `}>
                                ...
                                <div className={`relative overflow-hidden h-96 max-w-full justify-center flex items-center w-72 shadow-xl rounded-lg bg-${e.backgroundText}`}>
                                    <div className={`${details === e.kopi ? "translate-y-0" : "-translate-y-full"} duration-300 absolute h-full bottom-0 w-full bg-${e.backgroundText}  z-50`}>
                                        <h1 className={`absolute top-0 w-full border-b border-${e.text} bg-${e.backgroundText} p-1  text-2xl `}>Rp.16.000</h1>
                                        ...
                                        <div className='pt-10 px-5'>
                                            ...
                                            <button onClick={() => HandleClick({ ProductName: e.kopi, Price: 16000, id: String(index + 1), Qty: 1, img: e.img, stock: 5, isChecked: false })} className={`p-3 bg-${e.text} text-${e.backgroundText} cursor-pointer hover:bg-${e.backgroundText} hover:text-${e.text} rounded-xl border`}>Add To Cart</button>
                                        </div>
                                    </div>
                                    ...
                                    <Image alt='product1' className='object-contain ' fill src={`/produkk${e.kopi}.png`} />
                                </div>
                    ...
                    <div className='bg-white flex items-center justify-center h-screen w-screen'>
                            ...
                            <h1 className='text-7xl max-md:text-4xl flex justify-center items-end relative font-bold bg-white p-10'>Contact Us<span className='text-xl bottom-0 absolute'>Keep Scrolling</span></h1>
